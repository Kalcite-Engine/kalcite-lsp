...
- completion for language and engine symbols, including allocation-free `Text` APIs such as `Text.ends_with` and `Text.contains`;
- hover documentation for known engine APIs and bounded-text literal comparisons, prefixes, suffixes, and containment;
